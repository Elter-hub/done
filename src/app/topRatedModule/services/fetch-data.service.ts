...
export class FetchDataService {
  ...
  nextPage(): void {
    this.whichPage++;
    this.getTopRated().subscribe(val => this.page.next(val));
  }
  ...
  getTopRated(): Observable<Movies> {
    return this.httpClient.get<Movies>(`https://api.themoviedb.org/3/movie/top_rated?api_key=${this.API_KEY}&language=uk-UA&page=${this.whichPage}`)
  }
}
